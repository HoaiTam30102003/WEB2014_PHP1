...
// var_dump($name, $price, $image, $category_id, $content);
    if (!isset($error_name) && !isset($error_price) && !isset($error_category) && !isset($error_content) && !isset($error_quantity)){
                            ...
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-footer">
                                        <input type="submit" class="btn btn-primary" value="Cập nhật" name="edit_pro">
